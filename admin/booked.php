                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><?php echo $cat_arr[$row['booked_cid']]['name'] ?></td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-sm btn-danger delete_check" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                            </tbody>
...
<script>
    ...
    $('.delete_check').click(function(){
        _conf("Are you sure to delete this data?","delete_check",[$(this).attr('data-id')])
    })
    ...
    function delete_check($id){
        start_load()
        $.ajax({
            url:'ajax.php?action=delete_check',
            method:'POST',
            data:{id:$id},
